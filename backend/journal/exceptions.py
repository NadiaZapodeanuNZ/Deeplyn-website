...
class NoActiveRelationship(AppException):
    status_code = status.HTTP_403_FORBIDDEN
    default_detail = "No active relationship with this client."
    default_code = "no_active_relationship"